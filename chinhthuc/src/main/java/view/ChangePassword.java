...
public class ChangePassword extends javax.swing.JDialog {
    ...
    public ChangePassword(javax.swing.JFrame parent, boolean modal, Account t) {
        ...
        setLocationRelativeTo(null);
        this.accCur = t;
        tenTaiKhoan.setText(this.accCur.getUserName());
        ...
        if (nameAccount.equals("") || emailAccount.equals("") || passwordAccount.equals("")) {
            ...
            try{
                if (isValid(emailAccount)) {
                    if (Hash.verifySignature(passwordAccount, accCur.getPassword())) {
                        accCur.setUserName(nameAccount);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (check == true) {
            try{
            if (Hash.verifySignature(curPass, accCur.getPassword())) {
//                BCrypt.hashpw(txtpassword.getText(), BCrypt.gensalt(12))
                if (newPass.length() < 6) {
                    ...
                    if (newPass.equals(newPassConf)) {
                        String pass = Hash.signData(passAft.getText());
