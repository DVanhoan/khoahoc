...
import controller.SearchCourse;
...
public class CourseForm extends javax.swing.JInternalFrame {
    ...
    public final void initTable() {
        ...
        String[] headerTbl = new String[]{"Id", "Tên Khóa Học", "Mô Tả", "Đơn giá", "Giáo Viên", "Hình Ảnh"};
        tblModel.setColumnIdentifiers(headerTbl);
        tblSanPham.setModel(tblModel);
    }

    public void loadDataToTable(ArrayList<Course> list) {
        try {
            tblModel.setRowCount(0);
            for (Course i : list) {
                tblModel.addRow(new Object[]{
                    i.getId(), i.getName(), i.getDescription(), formatter.format(i.getPrice()) + "đ", i.getUser().getUserName(), i.getImage()
                });
            }
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        jComboBoxLuaChon.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tất cả", "Tên khóa học", "đơn giá ", "Giáo Viên", " " }));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        try {
            AddCourse a = new AddCourse(this, (JFrame) javax.swing.SwingUtilities.getWindowAncestor(this), rootPaneCheckingEnabled);
            a.setVisible(true);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        try{
            if (tblSanPham.getSelectedRow() == -1) {
                ...
                Course course = getKhoaHocSelect();
                
                UpdateCourse updateProduct = new UpdateCourse(this, (JFrame) javax.swing.SwingUtilities.getWindowAncestor(this), rootPaneCheckingEnabled, course);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (saveFile != null) {
            ...
            // Ensure the file ends with .xlsx extension
            ...
            try (FileOutputStream out = new FileOutputStream(saveFilePath)) {
                wb.write(out);
            } // This will also close the workbook automatically
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        loadDataToTable(daoCourse.selectAll());
    ...
    private void jTextFieldSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldSearchKeyReleased
        ...
        try {
            ...
            ArrayList<Course> result = searchFn(luaChon, content);
    ...
    public ArrayList<Course> searchFn(String luaChon, String content) throws SQLException {
        ArrayList<Course> result = new ArrayList<>();
        SearchCourse searchPr = new SearchCourse();
        switch (luaChon) {
            case "Tất cả":
                result = searchPr.searchTatCa(content);
                break;
            case "Tên khóa học":
                result = searchPr.searchTenKhoaHoc(content);
                break;
            case "đơn giá":
                result = searchPr.searchDonGia(content);
                break;
            case "Giáo Viên":
                result = searchPr.searchGiaoVien(content);
                break;
        }
        return result;
    }

    public Course getDetailLapTop() throws SQLException {
        Course a = daoCourse.selectById(getKhoaHocSelect().getId());
        return a;
    }

    public void xoaKhoaHocSelect() throws SQLException {
        ...
        if (luaChon == JOptionPane.YES_OPTION) {
            Course remove = getKhoaHocSelect();
            daoCourse.delete(remove);
        }
        loadDataToTable(daoCourse.selectAll());
    }
    

    public Course getKhoaHocSelect() throws SQLException {
        int i_row = tblSanPham.getSelectedRow();
        Course acc = daoCourse.selectById((int) tblModel.getValueAt(i_row, 0));
        return acc;
    }

    public void loadDataToTableSearch(ArrayList<Course> result) {
        try {
            tblModel.setRowCount(0);
            for (Course i : result) {
                tblModel.addRow(new Object[]{
    ...
    public void setIconLabel() throws SQLException {
        try {
            Course course = getKhoaHocSelect();
            jLabel1.setIcon(ImageReader.createImageIcon(course.getImage(), 96, 96)); // Set the icon on jLabel1
            jLabel1.revalidate(); // Refresh the label to display the new icon
            jLabel1.repaint();
        } catch (Exception e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error setting image: " + e.getMessage());
        }
    }
