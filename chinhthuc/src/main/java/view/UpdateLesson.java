 ...
 */
public class UpdateLesson extends javax.swing.JDialog {
    ...
    Lesson lesson;
    public UpdateLesson(javax.swing.JInternalFrame parent,javax.swing.JFrame owner, boolean modal, Lesson lesson) throws SQLException {
        super(owner, modal);
    ...
    void init() {
        txtIdLesson.setText(String.valueOf(lesson.getId()));
        txtTitle.setText(lesson.getTitle());
        txtMoTa.setText(lesson.getDescription());
        cbxlLuaChon.setSelectedItem(ABORT);
        
    }

    private UpdateLesson(JFrame jFrame, boolean b) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    
    private void displayInfo() {
        Lesson a = parent.getLessonSelect();
        txtIdLesson.setText(String.valueOf(a.getId()));
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 490, 140, 38));
        ...
        jPanel1.add(cbxlLuaChon, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 390, 300, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            // TODO add your handling code here:
            Lesson ncc = new Lesson();
            ncc.setId(Integer.parseInt(txtIdLesson.getText()));
            ncc.setTitle(txtTitle.getText());
            ncc.setDescription(txtMoTa.getText());
            ncc.setVideo(String.valueOf(cbxlLuaChon.getSelectedIndex()));
            daoLesson.update(ncc);
            this.dispose();
    ...
    public static void main(String args[]) throws UnsupportedLookAndFeelException {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UpdateLesson dialog = new UpdateLesson(new javax.swing.JFrame(), true);
