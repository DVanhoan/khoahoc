...
public class AccountForm extends javax.swing.JInternalFrame {
    ...
    public AccountForm() throws SQLException {
        initComponents();
        dao = new AccountDAO();
    ...
    public final void initTable() {
        ...
        String[] headerTbl = new String[]{"Tên Tài Khoản", "Email", "Vai Trò", "Trạng Thái"};
        ...
        try {
            ...
            for (Account i : acc) {
                tblModel.addRow(new Object[]{
                    i.getUserName(), i.getEmail(), i.getRole(), i.getStatus() == 0 ? "Đã khóa" : "Hoạt động"
                });
            }
        } catch (Exception e) {
        }
    ...
    public Account getAccountSelect() throws SQLException {
        int i_row = tblAccount.getSelectedRow();
        
        Account acc = AccountDAO.getInstance().find(tblAccount.getValueAt(i_row, 0).toString());
        return acc;
    }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        // TODO add your handling code here:
        try{
            AddAccount a = new AddAccount(this, (JFrame) javax.swing.SwingUtilities.getWindowAncestor(this), rootPaneCheckingEnabled);
            a.setVisible(true);
        }catch(Exception e){
            e.printStackTrace();
        }
        ...
        if (tblAccount.getSelectedRow() == -1) {
            ...
            if (check == JOptionPane.YES_OPTION) {
                ...
                if (textct.equals("")) {
                    ...
                    Account accReset = AccountDAO.getInstance().find(userName);
                    accReset.setPassword(Hash.signData(textct));
