...
//    public void writePhieuNhap(String mapn) throws SQLException {
//        String url = "";
//        try {
...
//            para2.add(String.valueOf("Người tạo: " + AccountDAO.getInstance().find(pn.getNguoiTao()).getUserName()));
...
//    }
//
//    public void writePhieuXuat(String mapn) throws SQLException {
//        String url = "";
//        try {
...
//            Paragraph para3 = new Paragraph(new Phrase("Người tạo: " + AccountDAO.getInstance().find(pn.getNguoiTao()).getUserName(), fontData));
//            para1.setIndentationLeft(40);
//            para2.setIndentationLeft(40);
